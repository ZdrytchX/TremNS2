function MarineTeam:InitTechTree()
   ...
   PlayingTeam.InitTechTree(self)
    ...
    self.techTree:AddBuildNode(kTechId.PowerPoint,                 kTechId.None,                kTechId.None)
    ...
    self.techTree:AddBuildNode(kTechId.Sentry,                    kTechId.SentryBattery,     				 kTechId.None, true)
    ...
    self.techTree:AddBuildNode(kTechId.SentryBattery,             kTechId.CommandStation,      kTechId.None)
    ...
    --self.techTree:AddTargetedActivation(kTechId.HeavyMachineGunTech,           kTechId.AdvancedWeaponry,      kTechId.None)
    ...
    self.techTree:AddResearchNode(kTechId.GrenadeTech,           kTechId.AdvancedArmory,                   kTechId.None)
...
local function SpawnInfantryPortal(self, techPoint)
    ...
    for p = 2, #Server.infantryPortalSpawnPoints do
...
function MarineTeam:SpawnInitialStructures(techPoint)
    ...
    if self:GetNumPlayers() > 8 then--8
        SpawnInfantryPortal(self, techPoint)
    end
