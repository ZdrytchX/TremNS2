...
local kWalkMaxSpeed = 10--3.7 when firing miniguns? Doesn't do anything
local kMaxSpeed = 10--5.75
local kViewOffsetHeight = 2.3
local kAcceleration = 100--20
...
local kHorizontalThrusterAddSpeed = 10--2.5
