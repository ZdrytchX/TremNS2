function BuildTechData()
    ...
    local techData = {
        ...
        { [kTechDataId] = kTechId.Rifle,      [kTechDataMaxHealth] = kMarineWeaponHealth, [kTechDataTooltipInfo] = "Humans spawn with a basic rifle. The rifle deals a moderate rate of damage but is limited to its clip size of 30.",    [kTechDataMapName] = Rifle.kMapName,                    [kTechDataDisplayName] = "RIFLE",         [kTechDataModel] = RifleVariantMixin.kModelNames.rifle[RifleVariantMixin.kDefaultModelName], [kTechDataDamageType] = kRifleDamageType, [kTechDataCostKey] = kRifleCost, },
        ...
        { [kTechDataId] = kTechId.Shotgun,     [kTechDataMaxHealth] = kMarineWeaponHealth,    [kTechDataPointValue] = kShotgunPointValue,      [kTechDataMapName] = Shotgun.kMapName,                  [kTechDataDisplayName] = "SHOTGUN",             [kTechDataTooltipInfo] =  "The shotgun fires a large shell that contains 14 pellets, dealing signficant damage at close to moderate range. It can hold 8 shells at once and fires a consistant pattern for predictable hits.", [kTechDataModel] = ShotgunVariantMixin.kModelNames.shotgun[ShotgunVariantMixin.kDefaultModelName], [kTechDataDamageType] = kShotgunDamageType, [kTechDataCostKey] = kShotgunCost, [kStructureAttachId] = kTechId.Armory, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true },
        ...
        { [kTechDataId] = kTechId.HeavyMachineGun,      [kTechDataMaxHealth] = kMarineWeaponHealth, [kTechDataTooltipInfo] = "Pulse rifle is a rapid firing, high damage rate with a large clip of 75 per cell. It is generally used for close range combat as it is rather inaccurate at range.", [kTechDataPointValue] = kHeavyMachineGunPointValue,    [kTechDataMapName] = HeavyMachineGun.kMapName,     [kTechDataDisplayName] = "Pulse Rifle",         [kTechDataModel] = HeavyMachineGun.kModelName, [kTechDataDamageType] = kHeavyMachineGunDamageType, [kTechDataCostKey] = kHeavyMachineGunCost, },
        ...
        { [kTechDataId] = kTechId.ClusterGrenadeProjectile, [kTechDataDamageType] = kClusterGrenadeDamageType,  [kTechDataMapName] = ClusterGrenade.kMapName,   [kTechDataDisplayName] = "CLUSTER_GRENADE", [kTechDataTooltipInfo] =  "The cluster grenade is an offensive bomb that releases smaller incindary grenades that works like fireworks. The initial explosion deals significant danage, enough to instantly kill any alien class except the Onos." },

        { [kTechDataId] = kTechId.GasGrenadeProjectile, [kTechDataDamageType] = kNerveGasDamageType,  [kTechDataMapName] = GasGrenade.kMapName,   [kTechDataDisplayName] = "GAS_GRENADE", [kTechDataTooltipInfo] =  "This grenade uses special chemicals that are safe for humans to breath however are toxic to alien life forms. Can be used for clearing out rooms and hallways as well as obliterating weak alien structures." },
        { [kTechDataId] = kTechId.PulseGrenadeProjectile,  [kTechDataDamageType] = kPulseGrenadeDamageType, [kTechDataMapName] = PulseGrenade.kMapName,   [kTechDataDisplayName] = "PULSE_GRENADE", [kTechDataTooltipInfo] =  "This grenade partially paralises an alien if hit directly or caught in its electric wake. Helps taking down a single large alien." },
        ...
        { [kTechDataId] = kTechId.DualMinigunTech,   [kTechDataCostKey] = kDualMinigunTechResearchCost,      [kTechDataResearchTimeKey] = kDualRailgunTechResearchTime, [kTechDataDisplayName] = "Reserch Dual Chaingun", [kTechDataHotkey] = Move.D, [kTechDataTooltipInfo] = "The chaingun upgrade for the Battlesuit deals a very high rate of damage, but is prone to overheating and spreads like the welder is holding onto a hot potato. Even the battlesuit gyroscopic stabalisation technology isn't enough for these twin guns. The Battlesuit cannot operate its rocket engine boosts while using the Weapons."},
        ...
        { [kTechDataId] = kTechId.DualRailgunTech,   [kTechIDShowEnables] = false,   [kTechDataCostKey] = kDualRailgunTechResearchCost,      [kTechDataResearchTimeKey] = kDualMinigunTechResearchTime, [kTechDataDisplayName] = "Research Dual Mass Driver", [kTechDataHotkey] = Move.D, [kTechDataTooltipInfo] = "The Mass Driver upgrade for the Battlesuit excels at destroying light structures and small aliens. The weapon needs to cool down after firing a solid slug but the spin-up wheel is usually at a charge not far from the maximum obtainable. The Battlesuit cannot use its rocket engines at its feet while charging up the weapons."},
        ...
        { [kTechDataId] = kTechId.GrenadeLauncher,    [kTechDataMaxHealth] = kMarineWeaponHealth,  [kTechDataPointValue] = kGrenadeLauncherPointValue, [kTechDataMapName] = GrenadeLauncher.kMapName,          [kTechDataDisplayName] = "Lucifer Cannon",  [kTechDataTooltipInfo] = "Lucifer Cannon is a weapon that shoots a very large explosive ball of energy, obliterating all aliens that stand in its way. Human Armour is adapted for absorbing the damage from the energy balls, allowing its user to launch themselves into flight by using the splash effect of the projectile.",   [kTechDataModel] = GrenadeLauncher.kModelName,   [kTechDataDamageType] = kRifleDamageType,    [kTechDataCostKey] = kGrenadeLauncherCost, [kStructureAttachId] = kTechId.Armory, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true},
        ...
        -- Armor research
        { [kTechDataId] = kTechId.Armor1,                [kTechDataCostKey] = kArmor1ResearchCost,                   [kTechDataResearchTimeKey] = kArmor1ResearchTime,     [kTechDataDisplayName] = "MARINE_ARMOR1",  [kTechDataTooltipInfo] = "Provides human soldiers with ultra light armour."},
        { [kTechDataId] = kTechId.Armor2,                [kTechDataCostKey] = kArmor2ResearchCost,                   [kTechDataResearchTimeKey] = kArmor2ResearchTime,     [kTechDataDisplayName] = "MARINE_ARMOR2",  [kTechDataTooltipInfo] = "Provides human soldiers with light armour."},
        { [kTechDataId] = kTechId.Armor3,                [kTechDataCostKey] = kArmor3ResearchCost,                   [kTechDataResearchTimeKey] = kArmor3ResearchTime,     [kTechDataDisplayName] = "MARINE_ARMOR3",  [kTechDataTooltipInfo] = "Provides human soldiers with moderate armour."},
        { [kTechDataId] = kTechId.NanoArmor,             [kTechDataCostKey] = kNanoArmorResearchCost,                [kTechDataResearchTimeKey] = kNanoArmorResearchTime,     [kTechDataDisplayName] = "NANO_ARMOR",  [kTechDataTooltipInfo] = "Allows the commander to provide ultimate protection to a target for a limited period of time."},

        -- Weapons research
        { [kTechDataId] = kTechId.Weapons1,              [kTechDataCostKey] = kWeapons1ResearchCost,                 [kTechDataResearchTimeKey] = kWeapons1ResearchTime,     [kTechDataDisplayName] = "MARINE_WEAPONS1", [kTechDataHotkey] = Move.Z, [kTechDataTooltipInfo] = "Upgrades weapon damage to 120%"},
        { [kTechDataId] = kTechId.Weapons2,              [kTechDataCostKey] = kWeapons2ResearchCost,                 [kTechDataResearchTimeKey] = kWeapons2ResearchTime,     [kTechDataDisplayName] = "MARINE_WEAPONS2", [kTechDataHotkey] = Move.Z, [kTechDataTooltipInfo] = "Upgrades weapon damage to 140%."},
        { [kTechDataId] = kTechId.Weapons3,              [kTechDataCostKey] = kWeapons3ResearchCost,                 [kTechDataResearchTimeKey] = kWeapons3ResearchTime,     [kTechDataDisplayName] = "MARINE_WEAPONS3", [kTechDataHotkey] = Move.Z, [kTechDataTooltipInfo] = "Upgrades weapon damage to 160%. Requires a backup Command Station."},
        ...
        { [kTechDataId] = kTechId.HeavyRifleTech,           [kTechDataCostKey] = kHeavyRifleTechResearchCost,        [kTechDataResearchTimeKey] = kHeavyRifleTechResearchTime, [kTechDataDisplayName] = "Research Pulse Rifle", [kTechDataTooltipInfo] =  "Allows humans to buy Pulse Rifles."},
        ...
        -- tier 0
        { [kTechDataId] = kTechId.Bite,         [kTechDataMapName] = BiteLeap.kMapName,        [kTechDataDamageType] = kBiteDamageType,        [kTechDataDisplayName] = "BITE", [kTechDataTooltipInfo] = "A bite attack for the skulks. Rather ineffective against structure armour"},
        ...
        { [kTechDataId] = kTechId.Spit,            [kTechDataMapName] = SpitSpray.kMapName,       [kTechDataDamageType] = kSpitDamageType,        [kTechDataDisplayName] = "SPIT", [kTechDataTooltipInfo] = "An attack that lobs a light projectile at a target that may slow it." },
        ...
        { [kTechDataId] = kTechId.Swipe,          [kTechDataMapName] = SwipeBlink.kMapName,      [kTechDataDamageType] = kSwipeDamageType,       [kTechDataDisplayName] = "SWIPE_BLINK", [kTechDataTooltipInfo] = "Primary claw attack"},
        ...
        { [kTechDataId] = kTechId.Umbra,          [kTechDataCategory] = kTechId.Lerk, [kTechDataMapName] = LerkUmbra.kMapName,       [kTechDataDisplayName] = "UMBRA", [kTechDataCostKey] = kUmbraResearchCost, [kTechDataResearchTimeKey] = kUmbraResearchTime, [kTechDataTooltipInfo] = "UMBRA_TOOLTIP"},
        {
            ...
            [kTechDataTooltipInfo] = "BILEBOMB is an acid bomb that can be spat by a gorge. It deals significant corroding damage to structures and poisons humans."
        },
        ...
        { [kTechDataId] = kTechId.BioMassOne, [kTechDataDisplayName] = "Stage 1" },
        { [kTechDataId] = kTechId.BioMassTwo, [kTechDataDisplayName] = "Stage 2" },
        { [kTechDataId] = kTechId.BioMassThree, [kTechDataDisplayName] = "Stage 3" },
        { [kTechDataId] = kTechId.BioMassFour, [kTechDataDisplayName] = "Stage 4" },
        { [kTechDataId] = kTechId.BioMassFive, [kTechDataDisplayName] = "Stage 5" },
        { [kTechDataId] = kTechId.BioMassSix, [kTechDataDisplayName] = "Stage 6" },
        { [kTechDataId] = kTechId.BioMassSeven, [kTechDataDisplayName] = "Stage 7" },
        { [kTechDataId] = kTechId.BioMassEight, [kTechDataDisplayName] = "Stage 8" },
        { [kTechDataId] = kTechId.BioMassNine, [kTechDataDisplayName] = "Stage 9" },
        ...
        -- Alien lifeforms
        { [kTechDataId] = kTechId.Skulk, [kTechDataUpgradeCost] = kSkulkUpgradeCost, [kTechDataMapName] = Skulk.kMapName, [kTechDataGestateName] = Skulk.kMapName,                      [kTechDataGestateTime] = kSkulkGestateTime, [kTechDataDisplayName] = "SKULK",  [kTechDataTooltipInfo] = "skulks are nimble, fast and small alien life forms that can use walls to aid their agility in both the vertical plane as well as horizontal plane. However skulks are incredibly weak and are prone to feeding.",        [kTechDataModel] = Skulk.kModelName, [kTechDataCostKey] = kSkulkCost, [kTechDataMaxHealth] = Skulk.kHealth, [kTechDataMaxArmor] = Skulk.kArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataMaxExtents] = Vector(Skulk.kXExtents, Skulk.kYExtents, Skulk.kZExtents), [kTechDataPointValue] = kSkulkPointValue},
        { [kTechDataId] = kTechId.Gorge, [kTechDataUpgradeCost] = kGorgeUpgradeCost, [kTechDataMapName] = Gorge.kMapName, [kTechDataGestateName] = Gorge.kMapName,                      [kTechDataGestateTime] = kGorgeGestateTime, [kTechDataDisplayName] = "GORGE", [kTechDataTooltipInfo] = "Gorges are the builder class of the alien team. They can build various structures that can aid the team. An upgrade can give the user the ability to spit out an acid bomb.",          [kTechDataModel] = Gorge.kModelName,[kTechDataCostKey] = kGorgeCost, [kTechDataMaxHealth] = kGorgeHealth, [kTechDataMaxArmor] = kGorgeArmor, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataMaxExtents] = Vector(Gorge.kXZExtents, Gorge.kYExtents, Gorge.kXZExtents), [kTechDataPointValue] = kGorgePointValue},
        ...
        { [kTechDataId] = kTechId.Fade, [kTechDataUpgradeCost] = kFadeUpgradeCost, [kTechDataMapName] = Fade.kMapName, [kTechDataGestateName] = Fade.kMapName,                       [kTechDataGestateTime] = kFadeGestateTime, [kTechDataDisplayName] = "FADE",   [kTechDataTooltipInfo] = "Fades are the fastest alien class available with the ability to pounce and shadowstep. They are granted the ability to snipe at long ranges if the commander decides to upgrade it.",         [kTechDataModel] = Fade.kModelName,[kTechDataCostKey] = kFadeCost, [kTechDataMaxHealth] = Fade.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataMaxArmor] = Fade.kArmor, [kTechDataMaxExtents] = Vector(Fade.XZExtents, Fade.YExtents, Fade.XZExtents), [kTechDataPointValue] = kFadePointValue},
        { [kTechDataId] = kTechId.Onos, [kTechDataUpgradeCost] = kOnosUpgradeCost, [kTechDataMapName] = Onos.kMapName, [kTechDataGestateName] = Onos.kMapName,                       [kTechDataGestateTime] = kOnosGestateTime, [kTechDataDisplayName] = "ONOS",   [kTechDataTooltipInfo] = "The Onos is the ultimate alien life form that can act as a meatshield as well as harrassing the human team into suffering a credit shortage. Onos may be fast but they are also large and easy to hit.", [kTechDataModel] = Onos.kModelName,[kTechDataCostKey] = kOnosCost, [kTechDataMaxHealth] = Onos.kHealth, [kTechDataEngagementDistance] = kOnosEngagementDistance, [kTechDataMaxArmor] = Onos.kArmor, [kTechDataMaxExtents] = Vector(Onos.XExtents, Onos.YExtents, Onos.ZExtents), [kTechDataPointValue] = kOnosPointValue},
