...
local kAmountHealedForPoints = 50--400
...
local function HealEntity(self, player, targetEntity)
    ...
    local health = kHealsprayDamage / kHealPlayersRawDivisionForTheFuckingOPGorgeHealSpray + targetEntity:GetMaxHealth() * kHealPlayerPercent / 100.0
