...
kHeavyMachineGunTechResearchCost = 15	--70 --no longer used
--kHeavyRifleTechResearchCost = 30 --Not a valid weapon yet, though i'll use this later
kGrenadeTechResearchCost = 20 --10		--90
kJetpackTechResearchCost = 25	--25	--115
kExosuitTechResearchCost = 40	--20	--140
...
--HMG is our lasgun
kHeavyMachineGunCost = 710 --25
kHeavyMachineGunDropCost = 45 --40
...
kFlamethrowerCost = 560
kFlamethrowerDropCost = 40 --15
...
kGorgeEggCost = 15 --15
kLerkCost = 325--375 --18 --Lerk will have mara stats
kLerkEggCost = 40 --30
kFadeCost = 600 --35
kFadeEggCost = 60 --70
kOnosCost = 1000 --62
...
kKillTeamReward = 6 --tres awarded to the commander for team doing well
...
kRifleSpread = Math.Radians(4)--Math.Radians(2.8)--4
...
kHeavyMachineGunClipSize = 75 --125 9*75 = 5*135
...
kWelderDamageType = kDamageType.Normal --additional damage to structures
kWelderFireDelay = 0.075 --0.2 --GPP: 0.075 // reduced to 0.05 to reduce effectiveness against skulks and lerks and fades
...
kAxeDamage = 8 --25
kAxeDamageType = kDamageType.Normal--kDamageType.Structural
...
--FLAMETHROWER
kFlamethrowerDamage = 10 --8 fires ~6/sec, modified to ~9/sec
kFlameThrowerEnergyDamage = 3
kBurnDamagePerSecond = 1
kCompoundFireDamageDelay = 2
kCompundFireDamageScalar = 0.5
kFlamethrowerDamageType = kDamageType.Puncture--kDamageType.Flame --double damage vs structures
kFlamethrowerClipSize = 200--50
...
kMinigunDamage = 2.7--5.375 --15/sec, aim for 80 DPS
kMinigunDamageType = kDamageType.Puncture--kDamageType.Normal
--not used:
--kMinigunClipSize = 3750 --250 --not used
--melee damage not used
--kClawDamage = 50

--Mass Driver
kRailgunDamage = 38 --33 // 38 1.1 damage 40 GPP damage
kRailgunChargeDamage = 40 --140 // feel bad for not having any boosted damage with charge
...
local kDamagePerUpgradeScalar = 0.15 --0.1
...
kBabblerDamage = 12 --8 --20
kBabblerDamageType = kDamageType.Puncture--kDamageType.Structural
...
kHealsprayDamageType = kDamageType.Puncture--kDamageType.Biological
...
kBileBombEnergyCost = 25--45
kBileBombDuration = 5 --5
...
kBoneShieldDamageReduction = 0.5--0.5
kBoneShieldCooldown = 90--12.5
kBoneShieldInitialEnergyCost = 30--20
kBoneShieldHealPerSecond = 21--14
kBoneShieldArmorPerSecond = 5
kBoneShieldMaxDuration = 20
kBoneShieldMoveFraction = 0 --before celerity
...
kArmsLabBuildTime = 14

kExtractorBuildTime = 5--11
...
kSentryBuildTime = 7 --3 --10
kSentryBatteryCost = 4--10 --25
kSentryBatteryBuildTime = 4 --5
...
kObservatoryBuildTime = 7.5
kPhaseTechResearchTime = 90--45
...
kPowerSurgeResearchTime = 40
kPowerSurgeCooldown = 10--20
kPowerSurgeDuration = 20
kPowerSurgeCost = 5
kPowerSurgeDamage = 35--25
...
kRuptureCost = 1--3
kRuptureCooldown = 2--4
kRuptureParasiteTime = 10
kRuptureBurstTime = 0.5--1.25 --Time before rupture "pops"
kRuptureEffectTime = 1.5
kRuptureEffectDuration = 3
kRuptureEffectRadius = 8.7

kBoneWallCost = 10--3
kBoneWallCooldown = 30--10

kContaminationCost = 15--5
kContaminationCooldown = 15--6 increase cooldown due to increased lifespan and encouraging camping
